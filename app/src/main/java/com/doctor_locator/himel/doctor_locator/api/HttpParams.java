...
public class HttpParams {
    ...
    // Sheet Information
    public static final String SHEET_ID = "1AQsn3xgknNjhcqjwi3rqftKcvdasKzLzbLWtAdKkvkM"; // Replace by your sheet id
    // Replace by your sheet name
    public static final String SHEET_NAME_STORE = "store";
