...
import com.doctor_locator.himel.doctor_locator.adapter.AllStoreAdapter;
import com.doctor_locator.himel.doctor_locator.data.AppConstant;
import com.doctor_locator.himel.doctor_locator.listener.OnItemClickListener;
...
import com.doctor_locator.himel.doctor_locator.utility.AdUtils;
...
public class AllStoreFragment extends Fragment {
    ...
    private ArrayList<Store> getFilterData(ArrayList<Store> models, CharSequence searchKey) {
        ...
        for (Store model : models) {
            ...
            final String meaning = model.getAddress().toLowerCase();
    ...
    private void sentDataToDetail(int position) {
        Store storeDetail = new Store(filterStoreList.get(position).getStoreId(),
                filterStoreList.get(position).getBranchName(), filterStoreList.get(position).getImageUrl(),
                filterStoreList.get(position).getAddress(), filterStoreList.get(position).getLongitude(),
                filterStoreList.get(position).getLatitude(), filterStoreList.get(position).getContactNumber());
